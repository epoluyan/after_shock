...
if ($_POST) { // если передан массив POST
	...
	$emailgo->from_email= '89231430404@yandex.ru'; // от кого
	$emailgo->from_name= 'Новое письмо';
	$emailgo->to_email= '89231430404@yandex.ru'; // кому
	$emailgo->to_name= $name;
	$emailgo->subject= 'Выездной квест'; // тема
	$emailgo->body= "Поступила новая заявка. Имя: $name, телефон: $phone, сообщение: $email."; // сообщение
